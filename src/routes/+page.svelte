...
<main>
	<div class="flex justify-center items-center h-screen w-screen">
		<div class="w-1/6 p-10 bg-bright-orange">
			<svg width="64" height="40" class="mb-8" xmlns="http://www.w3.org/2000/svg"
				...
				></svg
			>
			<h2 class="text-3xl font-big-shoulders text-white mb-8">SEDANS</h2>
			<p class="text-transparent-white font-lexend-deca text-sm leading-6 mb-20 w-10/12">
				Choose a sedan for its affordability and excellent fuel economy. Ideal for cruising in the
				city or on your next road trip.
			</p>
			<button
				class="text-bright-orange font-lexend-deca bg-white py-3 px-8 rounded-full text-sm hover:bg-bright-orange hover:text-white hover:border-white hover:border-2 transition-all duration-300"
				>Learn More</button
			>
		</div>
		<div class="w-1/6 p-10 bg-dark-cyan">
			<svg width="64" height="40" class="mb-8" xmlns="http://www.w3.org/2000/svg"
				><g fill="none" fill-rule="evenodd"
					><circle fill="#000" opacity=".201" cx="20" cy="20" r="20" /><path
				...
				></svg
			>
			<h2 class="text-3xl font-big-shoulders text-white mb-8">SUVS</h2>
			<p class="text-transparent-white font-lexend-deca text-sm leading-6 mb-20 w-10/12">
				Take an SUV for its spacious interior, power, and versatility. Perfect for your next family
				vacation and off-road adventures.
			</p>
			<button
				class="text-dark-cyan font-lexend-deca bg-white py-3 px-8 rounded-full text-sm hover:bg-dark-cyan hover:text-white hover:border-white hover:border-2 transition-all duration-300"
				>Learn More</button
			>
		</div>
		<div class="w-1/6 p-10 bg-very-dark-cyan">
			<svg width="64" height="40" class="mb-8" xmlns="http://www.w3.org/2000/svg"
				><g fill="none" fill-rule="evenodd"
					><circle fill="#000" opacity=".201" cx="20" cy="20" r="20" /><path
				...
				></svg
			>
			<h2 class="text-3xl font-big-shoulders text-white mb-8">LUXURY</h2>
			<p class="text-transparent-white font-lexend-deca text-sm leading-6 mb-20 w-10/12">
			...
			<button
				class="text-very-dark-cyan font-lexend-deca bg-white py-3 px-8 rounded-full text-sm hover:bg-very-dark-cyan hover:text-white hover:border-white hover:border-2 transition-all duration-300"
				>Learn More</button
			>
		</div>
	</div>
